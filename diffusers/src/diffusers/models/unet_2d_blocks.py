...
class UNetMidBlock2D(nn.Module):
    ...
    def forward_img(self, hidden_states, temb=None):
        hidden_states = self.resnets[0](hidden_states, temb)
        for attn, resnet in zip(self.attentions, self.resnets[1:]):
            if attn is not None:
                hidden_states, score = attn(hidden_states, temb=temb)
...
class UNetMidBlock2DCrossAttn(nn.Module):
    ...
    def forward(
        ...
        for idx, (attn, resnet) in enumerate(zip(self.attentions, self.resnets[1:])):
            ...
            mapscores_dict[f'attn_{idx}'] = mapscores
            hidden_states = resnet(hidden_states, temb)

        return hidden_states, mapscores_dict
    ...
    def forward(
        ...
        for idx, (resnet, attn) in enumerate(zip(self.resnets, self.attentions)):
            if self.training and self.gradient_checkpointing:
                ...
                attn_scores[f'attn_{idx}'] = mapscores
        ...
        return hidden_states, output_states, attn_scores
...
class CrossAttnUpBlock2D(nn.Module):
    ...
    def forward(
        ...
        return hidden_states, attn_scores
